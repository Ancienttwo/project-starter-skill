...
| `tasks/todo.md` | — (generate inline) | Primary execution checklist + review section |
| `tasks/lessons.md` | — (generate inline) | Self-improvement loop rules |
...
2. **Plan with annotation loop** (recommended for non-trivial features):
   - AI writes checklist to `tasks/todo.md` (primary)
   - AI writes prevention rules to `tasks/lessons.md` after corrections
   - AI may use `docs/plan.md` for deep architecture notes (compatibility)
   - You annotate inline in your editor (add context, delete sections, correct assumptions)
   - Tell AI: "read annotations in tasks/todo.md, update accordingly. Don't implement yet."
